...
# import re
# # 输入文件和输出文件的路径
# input_file = "./results/ps64_temp2_avg.csv"
# output_file = "1.txt"
...
# 请替换为你的输入文件路径和输出文件路径
input_file_path = './hum/model/VGG16_hum2_avg.csv'
output_file_path = './hum/model/VGG16_pd.txt'
# process_txt_file(input_file_path, output_file_path)
...
def calculate_cs_scores(input_files):
    ...
    for input_file in input_files:
        ...
        thresholds = [i * 0.25 for i in range(5)]
        # thresholds = [i * 0.5 for i in range(7)]
...
def plot_cs_curves(thresholds, cs_scores_data):
    ...
    # plt.subplots_adjust(bottom=0.35,top=0.9)  # 将top设置为0.8或更小的值
    plt.show()
# 请替换为你的输入文件路径列表
...
# # humidity_data = [0.94,0.63,0.53,0.49,0.69]
# humidity_data = [0.87,0.59,0.49,0.60]
# # 创建图表
# plt.figure(figsize=(10, 8))
#
# # 绘制温度曲线
