...
def eval():
    ...
    dataset = BatchDataset(args.root, args.txt_dir, "all2_houyi1h", transform=transform)
...
# def main2():
    ...
    parser.add_argument("--weights", type=str, default="./middle/models/FFT2_ps96_houyi1h_2-best.pth", help="pretrain weight path")
    ...
    result_save_path = "./results/FFT2_ps96_houyi1h_3.csv".format(args.experiment_name)
