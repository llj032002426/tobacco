...
def main(args):
    ...
    train_dataset = BatchDataset(args.root, args.txt_dir, "train_temp", transform=transform1)
    val_dataset = BatchDataset(args.root, args.txt_dir, "val_temp", transform=transform2)
...
if __name__ == '__main__':
    ...
    model_save_path = "./middle/models/temp_model2.pth"
    # 根据实验名称和当前时间生成日志文件路径
